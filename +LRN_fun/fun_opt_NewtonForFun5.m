function [OptimalBeta, OptimalResult] = fun_opt_NewtonForFun5(InitialBeta)
load Fun5Para
%% parameters
beta = InitialBeta;
acc = 1e-4;
...
if beta > M/2/DelaySpread_s / BandWidth_Hz
    beta = M/2/DelaySpread_s / BandWidth_Hz;
else
    OptimalBeta = beta;
end
OptimalResult = fun_gen_F1(Para_k, Para_alpha, SNR_1,Gama, r_tau, OptimalBeta);
